...
/*   Updated: 2025/04/16 19:34:09 by saberton         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	// std::cout << "AForm constructor of " << name << " called ..." << std::endl;
...
AForm::AForm(const AForm& cpy): _name(cpy._name), _gradeSign(cpy._gradeSign), _gradeExec(cpy._gradeExec)
{
	// std::cout << "AForm copy constructor of " << cpy._name << " called ..." << std::endl;
	*this = cpy;
}

AForm& AForm::operator=(const AForm& cpy)
{
	// std::cout << "AForm copy assigment operator of " << cpy._name << " called ..." << std::endl;
	if (this != &cpy)
	{
		_signed = cpy._signed;
	}
...
AForm::~AForm()
{
	// std::cout << "AForm deconstructor of " << _name << " called." << std::endl;
}
